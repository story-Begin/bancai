(function() {
    ...
    var p = function(A, z, B, C) {
        ...
        if (D > -1) {
            ...
            if (z) {
                jQuery(t).append('<li index="' + A + '" tab="' + z + '" layer="' + C + '" class="hover">' + z + '<a href="javascript:;">\u5173\u95ed</a></li>');
                jQuery(r).append('<li index="' + A + '" tab="' + z + '" layer="' + C + '">' + z + '<a href="javascript:;">\u5173\u95ed</a></li>');
                jQuery(a).append('<iframe src="' + B + '" scrolling="auto" frameborder="0" ></iframe>');
            }
        }
        i();
    };
        ...
        for (var y = 0; x[y]; y++) {
            if (x[y].getAttribute("index") == z) {
                ...
                if (x[y].className == "hover") {
                    ...
                    showMenu(x[y ? y - 1: y + 1].getAttribute("layer"),x[y ? y - 1: y + 1].getAttribute("index"));
                }
            }
        }
        i();
    ...
    var d = function(y) {
        var x = y.target;
        if (x.tagName == "LI") {
            //console.log(x.getAttribute("index"));
            showMenu(x.getAttribute("layer"),x.getAttribute("index"));
            p(x.getAttribute("index"));
            jQuery(o).attr("class", "tab-find hidden");
        }
        if (x.innerHTML == "\u5173\u95ed") {
            //console.log(x.parentNode.getAttribute("index"));
            showMenu(x.parentNode.getAttribute("layer"),x.parentNode.getAttribute("index"));
