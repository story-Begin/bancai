...
<div>
    <div id="app">
                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-form-item label="被推送人工号:" prop="accepterJob" style="margin: 10px 0px;">
                                <el-input v-model="queryDTO.accepterJob" clearable
                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-form-item label="处理状态:" prop="status" style="margin: 10px 0px;">
                                ...
                                <el-radio v-model="queryDTO.status" label="1" @change="changStatus">已处理
                                </el-radio>
                            </el-form-item>
                        </el-col>
                    ...
                    <el-col :span="22">
                        <el-form-item label="设备编号:" style="margin: 5px 0px;">
                            <select-recursive-check-tree
                                    style="height:180px; overflow: auto; background-color:#fff; padding: 0 0px; width:100%; height:180px; float: left;"
                            <%--                                    :expand-all="true"--%>
        ...
        <el-dialog title="图片展示"
            ...
            <img :src="picUrl" style="width:100%;height: 430px;vertical-align: middle;" alt=""></img>
    ...
    let doit = new Vue({
        ...
        methods: {
            ...
            getAccidentAllPageList() {
                ...
                this.tableLoading = true;
                getAccidentAllPageList(queryData).then(res => {
                    this.tableLoading = false
                    this.deviceAccidentDataList = res.data.data.dataList;
                    this.page.totalCount = res.data.data.totalCount;
                    this.$refs.deviceAccidentTableRef.setCurrentRow(this.deviceAccidentDataList[this.deviceAccidentRowIndex])
